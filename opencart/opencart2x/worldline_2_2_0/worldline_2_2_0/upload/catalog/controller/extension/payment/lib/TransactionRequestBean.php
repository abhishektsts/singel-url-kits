...
class TransactionRequestBean
{
	...
	/**
     * @return the $toCardNumber
     */
    public function getToCardNumber()
    {
	...
	/**
     * @param int $toCardNumber
     */
    public function setToCardNumber($toCardNumber)
    {
    ...
    public function getEncryptedData()
    {
        try {
			...
			if (!$requestValidate->isBlankOrNull($this->txnType)) {
                $this->strReqst .= "|TxnType=" . $this->txnType;
            }

			if (!$requestValidate->isBlankOrNull($this->txnSubType)) {
                $this->strReqst .= "|TxnSubType=" . $this->txnSubType;
            }

            if (($this->requestType == "TWC") || ($this->requestType == "TWD") || ($this->requestType == "TRC") || ($this->requestType == "TIC")) {
				...
				if (!$requestValidate->isBlankOrNull($this->toCardNumber)) {
					$cardInfoBuff .= "|ToCardNumber=" . $this->toCardNumber;
	            }
