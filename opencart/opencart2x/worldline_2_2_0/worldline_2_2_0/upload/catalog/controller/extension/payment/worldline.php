...
class ControllerExtensionPaymentworldline extends Controller {
	public function index() {
        ...
        $returnUrl = $this->url->link('extension/payment/worldline/getResponse', '', $secure);
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/worldline.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/extension/payment/worldline.tpl', $data);
		} else {
			return $this->load->view('extension/payment/worldline.tpl', $data);
		}
	}
