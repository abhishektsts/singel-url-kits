<?php
require_once dirname(__FILE__).'/../../lib/TransactionRequestBean.php';
require_once dirname(__FILE__).'/../../lib/TransactionResponseBean.php';
...
class ControllerPaymentworldline extends Controller {
	public function index() {
		...
		if(isset($this->session->data['customer_id']) && !empty($this->session->data['customer_id'])){
			...
			$transactionRequestBean->setUniqueCustomerId($this->config->get('config_customer_group_id'));
		}
