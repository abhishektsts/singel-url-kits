...
use Worldline\Worldline\Lib\TransactionResponseBean;
...
class Index extends  \Magento\Framework\App\Action\Action
{
    ...
    {   
        ...
        $iv =  $this->config->getValue('payment/worldline/worldline_iv');
        $key = $this->config->getValue('payment/worldline/worldline_key');
