...
namespace Worldline\Worldline\Controller\Redirect;
use Worldline\Worldline\Lib\TransactionRequestBean;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function getRequest() {
        ...
        $iv = $config_data->getConfig('payment/worldline/worldline_iv');
        $key = $config_data->getConfig('payment/worldline/worldline_key');
        $ReqType = $config_data->getConfig('payment/worldline/worldline_request_type');
        $MrctCode = $config_data->getConfig('payment/worldline/worldline_mercode');
        $MrctsCode = $config_data->getConfig('payment/worldline/worldline_scode');
        $TpvAccntNo = '';
        ...
        $CurrencyType = 'INR';
        $ReturnURL = $url_model->getBaseUrl().'worldline/response';
        $Date = date("d-m-Y");
        ...
        if($config_data->getConfig('payment/worldline/worldline_url') == 'test'){
